...
<div class="rows">
    <div class="col1">
        <img src="man.jpg" alt="Italian Trulli" style="width: 100%">
        <br><label type="man_type">Mận loại 1</label>
        <br><label type="price">Giá: 50.000 vnđ</label><br>

        <img src="man.jpg" alt="Italian Trulli" style="width: 100%">
        <br><label type="man_type">Mận loại 2</label>
        <br><label type="price">Giá: 40.000 vnđ</label><br>

        <img src="man.jpg" alt="Italian Trulli" style="width: 100%">
        <br><label type="man_type">Mận loại 3</label>
